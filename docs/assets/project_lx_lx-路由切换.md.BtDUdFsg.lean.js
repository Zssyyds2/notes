import{_ as a,c as n,a4 as e,o as p}from"./chunks/framework.D0KwTCVo.js";const m=JSON.parse('{"title":"路由切换","description":"","frontmatter":{},"headers":[],"relativePath":"project/lx/lx-路由切换.md","filePath":"project/lx/lx-路由切换.md","lastUpdated":1729165077000}'),l={name:"project/lx/lx-路由切换.md"};function i(r,s,t,c,o,b){return p(),n("div",null,s[0]||(s[0]=[e(`<h1 id="路由切换" tabindex="-1">路由切换 <a class="header-anchor" href="#路由切换" aria-label="Permalink to &quot;路由切换&quot;">​</a></h1><p>路由切换直接用router难以判断逻辑，因此封装一个go函数来统一判断实现。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import router from &quot;@/router&quot;;</span></span>
