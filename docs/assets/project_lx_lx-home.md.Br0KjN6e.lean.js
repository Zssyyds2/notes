import{_ as n,c as a,a4 as p,o as l}from"./chunks/framework.D0KwTCVo.js";const m=JSON.parse('{"title":"Home页面","description":"","frontmatter":{},"headers":[],"relativePath":"project/lx/lx-home.md","filePath":"project/lx/lx-home.md","lastUpdated":null}'),e={name:"project/lx/lx-home.md"};function i(t,s,r,c,b,u){return l(),a("div",null,s[0]||(s[0]=[p(`<h1 id="home页面" tabindex="-1">Home页面 <a class="header-anchor" href="#home页面" aria-label="Permalink to &quot;Home页面&quot;">​</a></h1><p>包含的组件</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  &lt;TabbarWrapper&gt;</span></span>
